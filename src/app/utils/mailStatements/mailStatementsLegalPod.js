...
async function sendEmailLegalPod(body, files = []) {
    try {
        ...
        const info = await transporter.sendMail({
            ...
            <b>Информация о предельных параметрах разрешенного строительства (реконструкции) подключаемого объекта ${body.date}<br><br>
            ${body.date}`,
...
export default sendEmailLegalPod;