...
type DownloadDocumentComponentProps = {
    title: string;
    link?: string;
    file?: {
        url: string;
...
export default function DownloadDocumentComponent({ title, link }: DownloadDocumentComponentProps) {
    return (
        <a href={link} download={title} className={styles.document}>
