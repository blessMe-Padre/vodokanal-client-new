...
export default function Calculator() {
    ...
    const bazovayStoimost: number = 1600; // базовая стоимость подключения
    ...
    const network = calcNetwork();
    const total = bazovayStoimost + network;
    const bazovayStoimostNDC = Math.round(bazovayStoimost * (1 + NDC));
                ...
                <div className={styles.result}>
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>Пордключение:</td>
                                <td>{bazovayStoimost.toLocaleString()}</td>
                                <td>{bazovayStoimostNDC.toLocaleString()}</td>
                            </tr>
                            <tr>
                                <td>Сеть:</td>
