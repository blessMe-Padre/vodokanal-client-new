                        ...
                        <div className={styles.form_content_item}>
                            <div>
                                ...
                                >
                                    ...
                                    <option value="Требуется справка на продажу об  отсутствии задолженности">Требуется справка на продажу об  отсутствии задолженности</option>
                                    <option value="Требуется разрешение на срыв пломбы (при ремонтных работах)">Требуется разрешение на срыв пломбы (при ремонтных работах)</option>
                                    <option value="Вы не передавали показания водомера, и начисления производились по нормативам">Вы не передавали показания водомера, и начисления производились по нормативам</option>
                                    <option value="Опломбирование вводов">Опломбирование вводов</option>
                                    <option value="Определение степени благоустройства">Определение степени благоустройства</option>
                                    <option value="Предоставление доступа">Предоставление доступа</option>
                                </select>
                            </div>
                        </div>
                    </div>
